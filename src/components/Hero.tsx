...
export default function Hero() {
  return (
    <section className="relative overflow-hidden border-b-2 border-border bg-[radial-gradient(circle_at_30%_15%,#253138_0%,#1e262b_60%)] px-5 pt-20 pb-16 text-center min-[701px]:px-6 min-[701px]:pt-28 min-[701px]:pb-24">
      {HERO_VIDEO ? (
        <video
      ...
      <div className="relative max-w-[1100px] mx-auto px-6">
        <h1 className="mx-auto mb-[18px] max-w-[750px] text-[2.1rem] font-bold leading-[1.15] [text-shadow:0_1px_3px_rgba(0,0,0,0.9),0_4px_18px_rgba(0,0,0,0.6)] min-[701px]:text-[2.8rem] animate-[fade-up_0.6s_ease-out_both]">
          Your local tech guy, right here in <span className="whitespace-nowrap text-lava-light">Lava Hot Springs</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-4 animate-[fade-up_0.6s_ease-out_both] [animation-delay:240ms]">
          ...
          <a
            href="#services"
            className="inline-block rounded-lg border-2 border-border bg-ink px-[30px] py-[14px] text-base font-bold text-text transition-colors hover:border-lava-light hover:text-lava-light"
          >
            See Services
          </a>
        </div>
